...
def plot_examples():
    ...
    onset_shallow=UTCDateTime("1972-05-11T13:34:37")
    onset_meteoroid=UTCDateTime("1973-03-13T08:01:33")
    ...
    plt.savefig('../extra_plots_output/moonquake_examples_MHZ_XXXX.png')
    plt.show()
